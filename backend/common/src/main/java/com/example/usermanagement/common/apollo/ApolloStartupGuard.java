package com.example.usermanagement.common.apollo;
...
public final class ApolloStartupGuard {
    ...
    public static void require(String appId, String defaultNamespaces) {
        ...
        applyApolloSystemProperties(appId, meta, namespaces);
    ...
    private static void applyApolloSystemProperties(String appId, String meta, String namespaces) {
    ...
    private static void verifyNamespace(String appId, String namespace, String meta) {
        ...
        throw new IllegalStateException(
                "Apollo namespace is required but unavailable: appId=" + appId
                        + ", namespace=" + namespace + ", meta=" + meta,
                lastFailure);
    }

    private static void fetchNamespace(String appId, String namespace, String meta) {
        String url = trimTrailingSlash(meta)
                + "/configs/" + encode(appId)
                + "/default/" + encode(namespace);
