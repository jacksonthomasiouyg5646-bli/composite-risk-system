...
@RestController
@RequestMapping("/logs/error")
public class ErrorLogController extends CrudControllerSupport {
    public ErrorLogController(@Qualifier("errorLogServiceImpl") CrudService errorLogServiceImpl) {
        super(errorLogServiceImpl);
    }
}
