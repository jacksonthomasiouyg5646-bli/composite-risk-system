...
public class LoginLogController extends CrudControllerSupport {
    public LoginLogController(@Qualifier("loginLogServiceImpl") CrudService loginLogServiceImpl) {
        super(loginLogServiceImpl);
    }
}
